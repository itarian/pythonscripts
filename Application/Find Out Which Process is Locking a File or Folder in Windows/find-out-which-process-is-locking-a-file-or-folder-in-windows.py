...
if not os.path.exists(Folder):
    os.mkdir(Folder)
fileName=r"handle.exe"
src_path=Folder
fp = os.path.join(src_path, fileName)    
ki=os_platform()
archi=int(filter(str.isdigit, ki))
URL64=r"https://docs.google.com/uc?export=download&id=1_27JNsKu55YCPCchM6fFqoC5cCBCUHjz"
URL32=r"https://docs.google.com/uc?export=download&id=1tQw7gd2YW73P0LBhd58lScK0M7QYJ_Tu"
if archi==64:
    Excutable_path=Download(Folder, URL64,fp)
else:
    Excutable_path=Download(Folder, URL32,fp)   
output=Folder+"\\"+"handle.exe /accepteula "+Folder_Path
