...
msiLogs = "yes"
########################################################################################################################
Source_Path = r'path'       # Provide the network share file path
File_Name_64 = r'fileName'  # Enter the .msi file name for 64 bit
File_Name_86 = r'fileName'  # Enter the .msi file name for 32 bit
########################################################################################################################
